...
- I found it too implicit the fact that if you pass a function to `setState` it will only execute the first time the component is rendered. I'd prefer an option parameter or some other function for this
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=02%3A%20useEffect%3A%20persistent%20state&em=marcelinolucianom%40gmail.com).
